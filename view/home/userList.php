    ...
    <table class="table">
        ...
        <?php
            foreach ($data as $line) {
                ...
                <td><?php echo $line["adress"] ?></td>
                <td><?php echo $line["phone"] ?></td>
                <td><a href="<?=URL?>home/editUser/<?php echo $line['id'];?>" type="button" class="btn btn-primary"><i class="fas fa-edit text-light"></i></a></td>
                <td>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?=URL?>home/deleteUser/<?php echo $line['id'];?>" type="button" class="btn btn-danger">Ja</a>
                        </div>
                        </div>
                    </div>
                    </div>
